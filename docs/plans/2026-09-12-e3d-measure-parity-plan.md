...
- **P0（不补就不能说「E3D 有的我们都有」）**：~~#10 Shortest~~（✓ 2026-09-15，d-616，按 E3D 实际行为收口）、~~#9 两线夹角~~（✓ 2026-09-15，d-587）、#17 拾取类型、~~#14 Graphics 边 / 面拾取（它同时解锁 Perpendicular 与 Shortest 的目标 provider）~~（✓ 2026-09-13 起，§12 / §23 / §30 / §33 / §34 实机反复用到；External 留 P2）、~~#13 在 gen-model-v1 下的 PLINE 供给~~（✓ 2026-09-14，d-394，golden MD §17 / §18）（#12 Element 显著点 2026-09-13 核对为非 E3D 口径，撤出 P0，d-336）。
