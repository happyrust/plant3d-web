...
```json
{
    ...
    "actor": {
        "id": "kangwp", //当前用户编号
        "name": "康某", //当前用户名称
        "roles": "design" // design：编制，secondDesign：第二编制,proofread：校对，审核：review，approve：批准。暂定，可能有些节点不一定存在，预留。
    },
    "next_step": {
        "assignee_id": "liubo", //下一个审批节点的人员
        "node": "proofread", //下一个审批节点类型。design：编制，secondDesign：第二编制,proofread：校对，审核：review，approve：批准。暂定，可能有些节点不一定存在，预留。
    },
...
"node": "proofread", //审批节点类型。design: 编制, secondDesign: 第二编制,proofread: 校对，审核：review, approve：批准。暂定，可能有些节点不一定存在，预留。
"order": 1, //意见审批节点对应的顺序
