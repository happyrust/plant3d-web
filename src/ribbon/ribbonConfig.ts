    ...
    groups: [
      {
        ...
        items: [
          ...
          { kind: 'button', id: 'measurement.elevation_point', label: '点标高', icon: 'ruler', commandId: 'measurement.elevation_point' },
          { kind: 'button', id: 'measurement.elevation_delta', label: '高差', icon: 'ruler', commandId: 'measurement.elevation_delta' },
