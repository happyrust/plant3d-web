      ...
      <div v-if="open"
        ...
        <div class="space-y-3 border-b border-border/60 p-3">
          ...
          <div class="space-y-1">
            ...
            <input v-model="rangeSettings.radiusM.value"
              type="range"
              min="1"
              max="500"
              class="w-full" />
          ...
          <div class="space-y-1">
            ...
            <div class="flex gap-2">
              <label class="flex flex-1 cursor-pointer items-center justify-center gap-1.5 rounded border px-2 py-1 text-xs transition-colors"
                ...
                <input v-model="rangeSettings.queryShape.value"
                  type="radio"
                  value="cube"
                  class="sr-only" />
          ...
          <div class="space-y-1">
            ...
            <div class="grid grid-cols-2 gap-1.5">
              <label v-for="sv in [SiteSpecValue.Pipe, SiteSpecValue.Elec, SiteSpecValue.Inst, SiteSpecValue.Hvac]"
                :key="sv"
          ...
          <div v-if="unloadedCount > 0" class="flex items-center gap-2">
            <button :disabled="isLoadingNearby"
        ...
        <div class="flex-1 overflow-auto p-2">
          <div v-if="disciplines.length === 0 && !isLoading"
          ...
          <div v-for="discipline in filteredDisciplines" :key="discipline.id" class="mb-1">
            <!-- discipline header -->
            <div class="flex cursor-pointer items-center gap-1 rounded-md px-1.5 py-1 text-xs hover:bg-muted"
              @click="toggleDisciplineExpand(discipline)">
              <component :is="discipline.expanded ? ChevronDown : ChevronRight"
              ...
              <button type="button"
                ...
                <component :is="discipline.visible ? Eye : EyeOff"
                  class="h-3 w-3" />
              </button>
            </div>
            ...
            <div v-if="discipline.expanded" class="ml-4">
              <div v-for="child in discipline.children"
                :key="child.id"
                ...
                <button type="button"
                  ...
                  <component :is="child.visible ? Eye : EyeOff"
                    class="h-3 w-3" />
                </button>
              </div>
            </div>
