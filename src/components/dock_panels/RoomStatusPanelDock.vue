  ...
  <div class="p-4 space-y-4">
    ...
    <div v-if="workerStatus" class="bg-gray-100 dark:bg-gray-700 rounded-lg p-3">
      <div class="flex items-center gap-2 mb-2">
        ...
        <span :class="workerStatus.is_busy ? 'text-warning' : 'text-success'">
    ...
    <div v-if="systemStatus" class="bg-gray-100 dark:bg-gray-700 rounded-lg p-3">
      <div class="flex items-center gap-2">
        ...
        <span :class="{
          'text-success': systemStatus.system_health === '正常',
          'text-warning': systemStatus.system_health === '警告',
          'text-danger': systemStatus.system_health === '异常',
        }">
