...
<template>
  <div class="color-picker-container relative">
    ...
    <Transition enter-active-class="transition duration-100 ease-out"
      ...
      <div v-if="open"
        data-testid="annotation-color-picker-popover"
        class="absolute left-1/2 top-full z-[960] mt-2 -translate-x-1/2 rounded-xl border border-border bg-background p-3 shadow-xl">
