        ...
        <div v-else-if="tab === 'bends'" class="flex flex-col gap-2">
            ...
            >
                <div class="flex items-center justify-between gap-2">
                    ...
                    <div class="text-muted-foreground">
                        <span v-if="b.angle != null"
                            >{{ b.angle.toFixed(1) }}°</span
                        >
        ...
        <div v-else-if="tab === 'settings'" class="flex flex-col gap-2">
            <div class="rounded-md border border-border p-2 text-xs">
                ...
                <div class="mt-2 grid grid-cols-2 gap-2">
                    <label
                        class="flex items-center justify-between gap-2 rounded-md border border-border px-2 py-1"
                    >
                    ...
                    >
                        ...
                        <input
                            v-model.number="dimOffsetScaleModel"
                            type="number"
                            min="0.05"
                            max="50"
                            step="0.1"
                    ...
                    <label
                        class="col-span-2 flex items-center justify-between gap-2 rounded-md border border-border px-2 py-1"
                    >
                        <span class="text-muted-foreground">标签位置</span>
                        <input
                            v-model.number="dimLabelTModel"
                            type="range"
                            min="0"
                            max="1"
                            step="0.05"
                    ...
                    >
                        ...
                        <select
                            v-model="rebarvizArrowStyleModel"
                            class="rounded-md border border-border bg-background px-2 py-1 text-xs"
                    ...
                    >
                        ...
                        <input
                            v-model.number="rebarvizArrowSizeModel"
                            type="range"
                            min="6"
                            max="40"
                            step="1"
                    ...
                    >
                        ...
                        <input
                            v-model.number="rebarvizArrowAngleModel"
                            type="range"
                            min="8"
                            max="40"
                            step="1"
                    ...
                    >
                        ...
                        <input
                            v-model.number="rebarvizLineWidthModel"
                            type="range"
                            min="1"
                            max="6"
                            step="0.1"
