...
ATTACHMENT_SOURCE = 'scripts/review_demo_seed.py'
        ...
        'comments': [
            {
                ...
                'annotationId': 'seed-task-thread:task',
                'annotationType': 'text',
...
def build_runtime_output(base_url: str, results: list[SeedResult], warnings: list[str]) -> dict[str, Any]:
...
def main(argv: list[str] | None = None) -> int:
    ...
    dump_json(build_runtime_output(args.base_url, results, warnings), args.pretty)
    return 0
